...
export class CouponResolver {
  ...
  @UseGuards(AuthGuard)
  getByUser(@Context('user') reqUser: ReqUser) {
  ...
  getByAdmin(@Args('searchInput') searchInput: SearchInput) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  getSingleByAdmin(@Args('id', { type: () => String }) id: string) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  add(@Args('couponInput') couponInput: CouponInput) {
