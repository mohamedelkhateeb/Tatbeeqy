...
export class HomeResolver {
  ...
  addOne(@Args('bannerInput') bannerInput: BannerInput) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  addTwo(@Args('bannerInput') bannerInput: BannerInput) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  deleteTwo(@Args('id', { type: () => String }) id: string) {
  ...
  getSection(@Args('id', { type: () => String }) id: string) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  addSection(@Args('sectionInput') sectionInput: SectionInput) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  deleteSection(@Args('id', { type: () => String }) id: string) {
