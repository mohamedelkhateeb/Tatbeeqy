...
export class SellerResolver {
  ...
  gets(@Args('searchInput') searchInput: SearchInput) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  getByAdmin(@Args('id', { type: () => String }) id: string) {
  ...
  @Roles(Role.SELLER)
  @UseGuards(AuthGuard, RolesGuard)
  getProfile(@Context('user') reqUser: ReqUser) {
  ...
  verifyPhone(@Args('sellerVerifyInput') sellerVerifyInput: SellerVerifyInput) {
  ...
  @Roles(Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  verify(@Args('id', { type: () => String }) id: string) {
