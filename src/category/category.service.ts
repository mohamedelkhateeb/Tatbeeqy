...
export class CategoryService {
  ...
  constructor(
    ...
    private mainRepository: Repository<MainCategory>,
  ...
  async updateMain(mainCategoryInput: MainCategoryInput, id: number) {
    ...
    if (main.name !== mainCategoryInput.name) {
      ...
      if (hasMain)
        throw new NotFoundException('Main category name already in use!')
    }
  ...
  async deleteMain(id: number) {
    try {
      ...
      throw new NotFoundException(
        'Cannot delete main category because it has related record!',
      )
    }
    return {
      success: true,
  ...
  async updateCategory(categoryInput: CategoryInput, id: number) {
    ...
    if (category.name !== categoryInput.name) {
      ...
      if (hasCategory)
        throw new NotFoundException('Category name already in use!')
    }
  ...
  async deleteCategory(id: number) {
    try {
      ...
      throw new NotFoundException(
        'Cannot delete category because it has related record!',
      )
    }
    return {
      success: true,
  ...
  async deleteSub(id: number) {
    try {
      ...
      throw new NotFoundException(
        'Cannot delete sub-category because it has related record!',
      )
    }
    return {
      success: true,
