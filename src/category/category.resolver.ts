...
//Entity
import { SuccessInfo } from '@/user/entities/success.model'
import {
  MainCategory,
  GetMainCategories,
} from './entities/main-category.entity'
...
export class CategoryResolver {
  ...
  addMain(@Args('mainCategoryInput') mainCategoryInput: MainCategoryInput) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  deleteMain(@Args('id', { type: () => String }) id: string) {
  ...
  categories(@Args('searchInput') searchInput: SearchInput) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  addCategory(@Args('categoryInput') categoryInput: CategoryInput) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  createSub(@Args('subCategoryInput') subCategoryInput: SubCategoryInput) {
  ...
  @Roles(Role.MODERATOR, Role.ADMIN)
  @UseGuards(AuthGuard, RolesGuard)
  deleteSub(@Args('id', { type: () => String }) id: string) {
